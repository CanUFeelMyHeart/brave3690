...
Получить подробные сведения об удалённом репозитории можно с помощью параметра <kbd>**remote show**</kbd> с указанием имени репозитория — например, <kbd>**origin**</kbd>.
```sh
